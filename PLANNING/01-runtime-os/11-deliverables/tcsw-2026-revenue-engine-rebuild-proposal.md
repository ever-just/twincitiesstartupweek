...
Treated as a marketing push, the engine remains under-built. Treated as sponsor outreach, the engine remains under-built. Treated as logistics support, the engine remains under-built.

TCSW 2026 requires a revenue and operating rebuild.

---

## 3. The Asset BETA Actually Holds

BETA holds something far more valuable than an event checklist.

BETA holds the official public gathering point for Minnesota's startup and technology ecosystem.

That asset includes:

- the TCSW brand;
- the official startup week calendar;
- nonprofit legitimacy;
- ecosystem trust and institutional memory;
- founder, investor, university, corporate, student, operator, and community proximity;
- sponsor association value;
- a public invitation for Minnesota innovation to gather;
- the ability to designate what belongs on the official ecosystem calendar.

The official calendar is the product. The event is the container.

When designed correctly, TCSW is not merely a set of sessions. It is a marketplace of attention, status, access, programming, talent, sponsor visibility, host activations, and community trust.

That is the revenue engine SMS is proposing to rebuild.
...
- official TCSW calendar placement;
- public visibility;
- audience traffic;
- recruiting and talent attention;
- founder/operator/investor proximity;
- a reason to open their doors;
...
SMS is a community design firm and production company suited to solve the problem TCSW is now facing: how to bring human beings into meaningful relations at scale.

SMS brings a cross-functional operating team:

- **Liban Kano — Executive Director:** relationship stewardship, operating frame, proposal, narrative, vision alignment, and executive coordination.
- **Rachel Yenko-Martinka — Event Producer:** programming architecture, experience design, run-of-show logic, host/speaker experience, attendee journey, and large-scale public programming leadership.
- **Weldon Makori — Operations / Revenue / Sponsor Intelligence:** venue pipeline, sponsor intelligence, stakeholder mapping, historical TCSW research, operational infrastructure, and revenue modeling.
- **Matthew Muraoka — Design / Creative Direction:** campaign, landing page, visual identity, sponsor-facing materials, maps, signage, public shareability, and perception design.
- **Abhishek Adil — Technology / Product:** SMS app MVP, digital infrastructure, community experience layer, technical product support, and platform-boundary definition.

This is not a volunteer committee.

This is a production, creative, operations, technology, and community-design team capable of rebuilding TCSW as a coherent public experience and revenue platform.

---

## 7. Public Credit and Accreditation Requirement

Because SMS is being asked to carry the operating, production, creative, and community experience layer, public accreditation is a **binding term of this agreement** and must be **written into the operating agreement** — not treated as an informal courtesy.
...
- partner and host co-marketing that references TCSW 2026 production.

The required written credit is:

> **Produced by SMS**

Acceptable written forms include:

- **Produced by Strangers Meeting Strangers (SMS)**
- **Produced by SMS**
- **TCSW 2026 produced by SMS in partnership with BETA**
...
| Use | Amount |
|---|---:|
| Executive direction | $5,000 |
| Event production | $5,000 |
| Operations / revenue pipeline | $5,000 |
| Creative / campaign | $5,000 |
| Technology / product | $5,000 |
| Initial marketing, assets, and flywheel costs | $5,000 |
| **Total activation** | **$30,000** |
...
- A/V, staging, production, lighting, and sound;
- signage, printing, badges, and on-site collateral;
- event platforms and software (registration, ticketing, website, email, excluding SMS app);
- insurance, permits, and licensing;
- security, day-of staffing, and contracted labor;
...
## 11. Authority Required for Accountability
...
- TCSW brand ownership;
- nonprofit compliance;
- board governance;
- sponsor contracts;
- legal commitments;
- institutional risk decisions;
- final approval of commitments that bind BETA financially or legally;
- approval of the event production budget and any spend above agreed thresholds (see Section 9).

The principle is simple:

> **BETA remains the institutional steward. SMS becomes the producer and revenue-engine rebuild partner.**
...
- prior sponsor lists;
- prior sponsor amounts;
- existing BETA annual sponsor commitments;
- any current TCSW-specific sponsor conversations;
- current sponsorship deck or materials;
- historical ticket sales;
- historical attendance counts and methodology;
- venue conversations already in progress;
- existing partner promises;
- current budget assumptions;
- current website, calendar, and platform status;
...
> **Move TCSW from compelling possibility to fundable operating reality.**

Sprint priorities:

1. finalize scope, economics, and decision rights;
...
This proposal is designed to protect both BETA and SMS.
...
| Reputation risk | SMS could inherit prior TCSW trust damage | Clear public role, credit, scope, and decision rights |
| Product risk | SMS app could be misunderstood | App positioned as connection layer, not ticketing replacement |
| Cash-flow risk | BETA may not have upfront funds | First-revenue assignment and payment priority |
| Scope creep risk | Expanding obligations can collapse execution | Written scope, approval checkpoints, and no-go thresholds |
...
## 15. What BETA Receives

If approved, BETA receives more than TCSW 2026 production support.
...
- operating trackers and decision logs;
...
SMS asks BETA to authorize SMS as the **Revenue Engine Build, End-to-End Production, and Community Experience Partner** for TCSW 2026 under the terms described in this proposal.
...
This page records BETA's authorization to proceed. Signature makes three terms binding immediately: the $30,000 activation structure (Section 8), the **Produced by SMS** public accreditation (Section 7), and an exclusive negotiating window for the operating agreement through June 19, 2026. All other commercial and legal terms take effect through the operating agreement.

**For BETA / The Beta Group**
...
**For Strangers Meeting Strangers (SMS)**
